...
const BriefSection = () => {
  return (
    <Box bgColor="#EADED7" mb="15rem" height="max-content">
      <Box
        display="flex"
      ...
      >
        ...
        <Text
          maxWidth={{ base: "100%", md: "25rem", lg: "25rem" }}
          lineHeight="1.8"
          color="#795744"
        >
      ...
      >
        <Box
          ...
          gap="1rem"
        >
          <Circle size="4rem" bgColor="#EADED7">
            <Image src={icon1} boxSize="2rem" />
          </Circle>
          <Heading color="#453227" fontSize="1.5rem">
            Mission
          </Heading>
          <Text fontSize="1rem" lineHeight="1.8" color="#5F4435">
